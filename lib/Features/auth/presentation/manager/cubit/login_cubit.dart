...
class LoginCubit extends Cubit<LoginState> {
  ...
  final LoginReposImpl loginReposImpl;

  Future<void> fetchLoginMessage({required String email,required String password}) async {
    emit(LoginLoadingeState());

    var result = await loginReposImpl.fetchlogin(
